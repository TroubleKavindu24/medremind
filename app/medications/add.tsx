...
export default function AddMedicationScreen() {
    ...
    const [selectedFDuration, setSelectedFDuration] = useState("");
            ...
            <View style={styles.optionsGrid}>
                {DURATIONS.map((dur)=>(
                    <TouchableOpacity
                        ...
                        style={[
                            styles.optionCard,
                            selectedFDuration === dur.label && styles.selectedOptionCard,
                        ]}
                        onPress={()=>{
                            setSelectedFDuration(dur.label);
                    ...
                    >
                        ...
                        <Text
                            style={[
                                styles.optionLabel,
                                selectedFDuration === dur.label && styles.selectedOptionLabel,
                                ]}
                        >{dur.label}
                        </Text>
                    </TouchableOpacity>
    ...
    const handleSave = async () => {
        try {
            ...
            const colors = ['#4CAF50','#2196F3','#FF9800','3E91E63','#9C27B0'];
